...
6123 tests, 94% coverage, zero required dependencies. Zero breaking changes from v2.1.0 through v3.7.4. Python 3.10+.
...
v4.0 Federation (multi-process policy coordination) is the next milestone. No timeline commitment -- veronica-core is stable at v3.7.4.
